# database.py
# PostgreSQL models & async connection using SQLAlchemy.
# All configuration is pulled from config.py — never import dotenv here.
...
# ──────────────────────────────────────────────────────────────
# Enums — three lifecycle states
# ──────────────────────────────────────────────────────────────

class BlogStatus(str, PyEnum):
    PENDING  = "PENDING"   # workflow running / paused at HITL checkpoint
    APPROVED = "APPROVED"  # human approved — blog published to Blogs/
    REJECTED = "REJECTED"  # human rejected — blog not published
    COMPLETED = "COMPLETED"
...
class BlogPost(Base):
    ...
    # Full markdown content (populated after reducer runs)
